/**
 * Registration page — polished CandidateAI authentication screen.
 */
...
export default function Register() {
  ...
  return (
    <div className="relative flex min-h-screen overflow-hidden">
      ...
      <div
        className="pointer-events-none absolute bottom-[8%] left-[8%] h-64 w-64 rounded-full blur-3xl"
        style={{
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-6xl items-center justify-center px-5 py-10">
        <div className="grid w-full items-center gap-12 lg:grid-cols-[1fr_460px]">
          ...
          >
            ...
            >
              Create your recruiter workspace and bring resume,
              interview and candidate intelligence into one place.
            </p>

            <div className="mt-8 space-y-3">
              {[
                "Centralized candidate management",
                "Automated AI candidate evaluation",
          ...
          >
            ...
            <div className="mb-7 flex flex-col items-center lg:hidden">
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    "0 10px 35px oklch(0.62 0.19 258 / 0.18)",
                }}
              >
                <Brain
                  className="h-7 w-7"
            ...
            <div className="mb-7">
              ...
              >
                Set up your recruiter account to start evaluating
                candidates.
              </p>
            </div>
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  color: "var(--primary-foreground)",
                  boxShadow:
                    "0 10px 25px oklch(0.62 0.19 258 / 0.12)",
                }}
              >
                {loading ? (
                  <>
